...
export default function Statistics() {
  ...
  const notes=useMemo(()=>scope.filter(note=>!note.exclue_bulletin&&!note.matiere_hors_bulletin),[scope]); const stats=useMemo(()=>descriptiveStats(notes),[notes]); const records=useMemo(()=>calculateRecords(notes),[notes]);
